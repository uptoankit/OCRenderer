 ...
 * @author readams
 */
public class PolicyManager implements PolicyListener,EndpointListener {
...
//    private final AtomicReference<Dirty> dirty;
    ...
    private final SingletonTask contrailTask;
       ...
       // Object[] instances = ServiceHelper.getGlobalInstances(INeutronNetworkAware.class, this, null);
        //if (instances != null) {
          //  for (Object instance : instances) {
            //	NeutronNetwork singleton = new NeutronNetwork();
             //   INeutronNetworkAware service = (INeutronNetworkAware) instance;
               // int status = service.canCreateNetwork(singleton);
               //System.out.println("i am here inside the testing code with status"+status);
            //}
       // }
...
//        }
     ...
     * Call to plugin2oc
     */
    private class PluginTask implements Callable<Void> {
...
//            }
    ...
    /**
     * Call Plugin2oc as needed.  Note that this will block
     * one of the threads on the executor.
     */
    private class ContrailTask implements Runnable {
        @Override
        public void run() {
            LOG.debug("Beginning OpenContrail task");
